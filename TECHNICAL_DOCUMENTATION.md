...
- [2. Architecture du projet](#2-architecture-du-projet)
  - [2.1. Organisation exacte des fichiers (Assets/Scripts)](#21-organisation-exacte-des-fichiers-assetsscripts)
  - [2.2. Design patterns utilisés](#22-design-patterns-utilisés)
- [3. Scripts principaux](#3-scripts-principaux)
- [4. Interface utilisateur et cartographie complète des scripts](#4-interface-utilisateur-et-cartographie-complète-des-scripts)
